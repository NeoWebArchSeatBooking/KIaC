...
CREATE TABLE `booking` (
  ...
  `booking_userid` varchar(50) NOT NULL,
  `booking_date` date NOT NULL,
  `booking_status` varchar(1) NOT NULL,
  `booking_seat_loc_id` varchar(5) NOT NULL,
  `booking_seat_block_id` varchar(5) NOT NULL,
  `booking_seat_floor_id` varchar(4) NOT NULL,
  `booking_seat_id` varchar(10) NOT NULL,
  `booking_updatetime` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `booking_userid_UNIQUE` (`booking_userid`,`booking_date`,`booking_status`)
